-- // Lib \\ --
--[[
    local UI = loadstring(game:HttpGet("https://abbys.best/assets/files/gayasf.ui2?key=5y1lxXSfWKhlQkSqhUuFyB8kPp8hsCau"))()
]]
-- // Library Init \\ --
local Start = tick()
local LoadTime = tick()
...
do
    ...
    Utility.SaveConfig = function(Config)
        writefile(
            "skyline/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json", 
    ...
    Utility.LoadConfig = function(Config)
        local Config = HttpService:JSONDecode(readfile("skyline/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json"))
        --
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Utility.AddFolder("skyline")
        Utility.AddFolder("skyline/Caches")
        Utility.AddFolder("skyline/Assets")
        Utility.AddFolder("skyline/Assets/UI")
        Utility.AddFolder("skyline/Configs")
        Utility.AddFolder("skyline/Scripts")
        --
        Library.Theme.Gradient = Utility.AddImage("skyline/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        -- Library.Theme.SecondIcon = Utility.AddImage("skyline/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        Library.Theme.Hue = Utility.AddImage("skyline/Assets/UI/Hue.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/HuePicker.png")
        Library.Theme.Saturation = Utility.AddImage("skyline/Assets/UI/Saturation.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/SaturationPicker.png")
        Library.Theme.SaturationCursor = Utility.AddImage("skyline/Assets/UI/HueCursor.png", "https://raw.githubusercontent.com/mvonwalk/splix-assets/main/Images-cursor.png")
        --
        Library.Theme.Astolfo = Utility.AddImage("skyline/Assets/UI/Astolfo.png", "https://i.imgur.com/T20cWY9.png")
        Library.Theme.Aiko = Utility.AddImage("skyline/Assets/UI/Aiko.png", "https://i.imgur.com/1gRIdko.png")
        Library.Theme.Rem = Utility.AddImage("skyline/Assets/UI/Rem.png", "https://i.imgur.com/ykbRkhJ.png")
        Library.Theme.Violet = Utility.AddImage("skyline/Assets/UI/Violet.png", "https://i.imgur.com/7B56w4a.png")
        Library.Theme.Asuka = Utility.AddImage("skyline/Assets/UI/Asuka.png", "https://i.imgur.com/3hwztNM.png")
        --
...
do
    ...
    function Library.Window(Title, Size)
        ...
        function Window:AddSettingsTab(Additional)
            ...
            Theme:Dropdown({
                Title = "Theme",
                List = {"Default", "Neverlose", "Fatality", "Aimware", "Onetap", "Vape", "Gamesesne", "Oldskyline"},
                Default = "Default",
                Callback = function(Choosen)
                    ...
                    elseif Choosen == "Oldskyline" then
                        Library:UpdateTheme({
                            Outline = Color3.fromHex("#0a0a0a"),
